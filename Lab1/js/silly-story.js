...
var storyText = `It was 94 farenheit outside, so :insertx: went for a walk. 
				...
				then :insertz:. Bob saw the whole thing, but he was not surprised — :insertx: weighs 300 pounds, 
...
function result() {
  ...
  if(document.getElementById("metric").checked) {
		...
		let weight = (300/11) * 0.453592;
		// STEP 11b: Replace the string 300 pounds with the updated weight in kg
		newStory = newStory.replace("300 pounds", `${weight.toFixed(2)}kg`);
